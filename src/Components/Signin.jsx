                                ...
                                <div className="mt-2 flex flex-col gap-4">
                                    ...
                                    <form className='flex flex-col gap-5'>
                                        ...
                                        <div className='flex items-center justify-center'>
                                            <div className=' hover:bg-gradient-to-r hover:from-sky-500 hover:to-indigo-500 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white py-2 rounded-lg  w-full text-center hover:cursor-pointer ' >
                                                Sign in
                                            </div>
                                        </div>
                                    </form>
